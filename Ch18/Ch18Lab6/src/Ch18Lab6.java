...
public class Ch18Lab6 extends JFrame 
{
	...
	private JButton addButton, removeButton, addFirst, removeLast;
	private JTextArea displayArea;
	private JComboBox<String> coursesCombo;
	private DefaultListModel<String> listModel;
	private JList<String> courseItems;
	private JPanel topPanel,bottomPanel, westPanel;
	...
	public Ch18Lab6()
	{
		...
		cp.add(courseItems, BorderLayout.EAST);
	}
	...
	public void createButtons()
	{
		...
		addFirst = new JButton("Add Item To Start");
		addFirst.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				courses.add(0, courseItems.getSelectedValue());
				coursesCombo.revalidate();
				coursesCombo.removeAllItems();
				coursesCombo.setModel(new DefaultComboBoxModel(courses.toArray()));
				setDisplay();
		...
		removeLast = new JButton("Remove Last Item");
	...
	public void createPanels()
	{
		...
		bottomPanel.add(addFirst);
		bottomPanel.add(removeLast);
